	...
	factory: (require) => {
		...
		*/
		function GitView({ sessionId, git, root, t }) {
			...
			(0, react.useEffect)(() => {
				...
				git.log(sessionId, { maxCount: LOG_MAX_COUNT }, controller.signal).then((log) => {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("header", {
					...
					}), log.truncated && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						className: GitView_module_css_default.truncated,
						children: t("log.truncated", { count: log.commits.length })
					})]
				}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									...
									/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
										...
										children: [
											...
											/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
												...
												children: formatTime(commit.authorTime)
											})
										]
									})
								]
		...
		*/
		...
		const en = {
			...
			"log.truncated": "Showing the most recent {count} commits",
