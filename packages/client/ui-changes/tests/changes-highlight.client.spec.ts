/**
 * Behavior spec for the Changes diff syntax highlighter and extension mapping:
...
import { highlightLine } from '../src/client/changes-highlight.ts'
import { langFromPath } from '../src/client/changes-lang.ts'
